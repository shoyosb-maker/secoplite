...
function clearFilters() {
    ...
    // Limpiar checkbox de procesos activos
    const onlyActiveCheckbox = document.getElementById('onlyActiveFilter');
    if (onlyActiveCheckbox) onlyActiveCheckbox.checked = false;
